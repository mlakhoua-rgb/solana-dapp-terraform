# Security Module - Creates security groups and IAM roles for the dApp
...
resource "aws_security_group" "ec2" {
  ...
  # Allow SSH from specific CIDR (should be restricted to your IP)
  ingress {
    from_port   = 22
    to_port     = 22
    protocol    = "tcp"
...
# Attach SSM policy for EC2 Systems Manager access
